...
Current Focus: Pattern Lab / Storybook launch readiness. Audit fixes completed: (1) LogoImageClient — added LogoImage.module.scss import and usage; (2) Storybook — added @storybook/addon-themes with withThemeByDataAttribute decorator for data-theme toggle; (3) Colors.stories — moved useState/useEffect into LiveCyclePreview component (hooks in function component); (4) globals.scss — added --sys-color-accent-secondary (Purple) to light/dark; (5) _colors-variables — added purple to theme maps. SpacingScale already exported in Atoms index. EnvironmentalAtoms folder already renamed (no space). Next: Pattern Lab page redo (apps/docs/app/docs/) with nuqs, hierarchy mirroring, a11y tables.
