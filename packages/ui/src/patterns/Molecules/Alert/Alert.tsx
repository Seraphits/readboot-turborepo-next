...
const DEFAULT_MESSAGE = (
  <>
    ...
    <strong> Phase:</strong> Establishing structural 🦴bones🦴 via SCSS
    wireframing 📐
    <div>Learn why I prototype directly in code 🚀</div>
  </>
);
...
export const Alert = <T extends ElementType = "aside">({
  ...
  Omit<React.ComponentPropsWithoutRef<T>, keyof AlertProps<T>>) => {
