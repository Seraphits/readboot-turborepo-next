...
const meta: Meta = {
  parameters: {
    docs: {
      description: {
        component: [
          "**Tier 1 — reference (`$ref-*`)** — brand primitives.",
          "**Tier 2 — system (`$sys-*`)** — role tokens used in components and SCSS modules.",
          "**Rule:** ship UI against **system** tokens; reference tokens define system tokens.",
          "SSOT: `packages/ui/src/Tokens/Colors/_colors-variables.scss`.",
        ].join(" "),
      },
    },
  },
